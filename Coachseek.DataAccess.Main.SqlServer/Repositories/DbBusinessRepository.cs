                    ...
                    var coach = new CoachData
                    {
                        ...
                        WorkingHours = new WeeklyWorkingHoursData
                        {
                            Monday = new DailyWorkingHoursData
                            {
                                ...
                                StartTime = reader.SafeGetStringTrimmed(8),
                                FinishTime = reader.SafeGetStringTrimmed(9)
                            },
                            Tuesday = new DailyWorkingHoursData
                            {
                                IsAvailable = reader.GetBoolean(10),
                                StartTime = reader.SafeGetStringTrimmed(11),
                                FinishTime = reader.SafeGetStringTrimmed(12)
                            },
                            Wednesday = new DailyWorkingHoursData
                            {
                                IsAvailable = reader.GetBoolean(13),
                                StartTime = reader.SafeGetStringTrimmed(14),
                                FinishTime = reader.SafeGetStringTrimmed(15)
                            },
                            Thursday = new DailyWorkingHoursData
                            {
                                IsAvailable = reader.GetBoolean(16),
                                StartTime = reader.SafeGetStringTrimmed(17),
                                FinishTime = reader.SafeGetStringTrimmed(18)
                            },
                            Friday = new DailyWorkingHoursData
                            {
                                IsAvailable = reader.GetBoolean(19),
                                StartTime = reader.SafeGetStringTrimmed(20),
                                FinishTime = reader.SafeGetStringTrimmed(21)
                            },
                            Saturday = new DailyWorkingHoursData
                            {
                                IsAvailable = reader.GetBoolean(22),
                                StartTime = reader.SafeGetStringTrimmed(23),
                                FinishTime = reader.SafeGetStringTrimmed(24)
                            },
                            Sunday = new DailyWorkingHoursData
                            {
                                IsAvailable = reader.GetBoolean(25),
                                StartTime = reader.SafeGetStringTrimmed(26),
                                FinishTime = reader.SafeGetStringTrimmed(27)
                            }
                        }
                    };
                    coaches.Add(coach);
