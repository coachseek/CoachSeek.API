...
{
    public class CustomFieldTemplateAddUseCase : BaseUseCase, ICustomFieldTemplateAddUseCase
    {
        public async Task<IResponse> AddCustomFieldTemplateAsync(CustomFieldAddCommand command)
        {
            try
            {
