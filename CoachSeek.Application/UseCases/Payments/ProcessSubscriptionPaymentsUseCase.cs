...
{
    public class ProcessSubscriptionPaymentsUseCase : IProcessSubscriptionPaymentsUseCase
    {
        ...
        public ProcessSubscriptionPaymentsUseCase(IOnlinePaymentProcessingQueueClient paymentProcessingQueueClient,
