...
namespace CoachSeek.Domain.Entities
{
    public class SessionInCourse : SingleSession
    {
            ...
            : base(existingSession, command, coreData)
        {
            ...
            _timing = new SessionTiming(new SessionTimingData(updatedSessionStartDate.ToString(), command.Timing.StartTime, command.Timing.Duration, command.Timing.BookUntil));
        }
        ...
        public SessionInCourse Clone(Date startDate)
        {
            ...
            sessionData.Timing = new SessionTimingData(startDate.ToString(), timing.StartTime, timing.Duration, timing.BookUntil);
