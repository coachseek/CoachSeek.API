...
namespace CoachSeek.Application.Contracts.Services.Emailing
{
    public interface IOnlineBookingEmailer
    {
        ...
        void SendCourseEmailToCoach(CourseBooking booking, CoachData coach, CustomerData customer);
        void SendCourseEmailToCustomer(CourseBooking booking, CoachData coach, CustomerData customer);
    }
}
