...
namespace Coachseek.Integration.Tests.Unit.Payments
{
    ...
    public class NewPaymentConverterTests
    {
        ...
        private void AssertNewPaypalPayment(NewPayment newPayment)
        {
            ...
            Assert.That(newPayment.ItemId, Is.EqualTo("QWERTY123"));
            ...
            Assert.That(newPayment.MerchantId, Is.EqualTo("403CF70F-77A0-45F4-A5ED-3AC74949BF0C"));
