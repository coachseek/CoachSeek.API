...
namespace Coachseek.Integration.Tests.Unit.Payments
{
    ...
    public class PaymentMessageProcessorTests
    {
        ...
        {
            var business = new Business(new Guid(BUSINESS_ID), "TestBusiness", "testbusiness", "NZD", true, false, PROVIDER_TEST, "mickey@mouse.com");
            BusinessRepository.AddBusiness(business);
        ...
        {
            var business = new Business(new Guid(BUSINESS_ID), "TestBusiness", "testbusiness", "NZD", true, false, PROVIDER_TEST, "test@business.com");
            BusinessRepository.AddBusiness(business);
        ...
        {
            var business = new Business(new Guid(BUSINESS_ID), "TestBusiness", "testbusiness", "USD", true, false, PROVIDER_TEST, "test@business.com");
            BusinessRepository.AddBusiness(business);
