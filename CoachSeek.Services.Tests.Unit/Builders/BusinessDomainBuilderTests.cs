...
namespace CoachSeek.Services.Tests.Unit.Builders
{
    ...
    public class BusinessDomainBuilderTests
    {
        ...
        private void SetupBusinessRepository()
        {
            ...
            BusinessRepository.Add(new Business(Guid.NewGuid(), "Ian's Cafe", "ianscafe", SetupBusinessAdmin(), null, null, null, null));
            BusinessRepository.Add(new Business(Guid.NewGuid(), "Bob's Burgers", "bobsburgers", SetupBusinessAdmin(), null, null, null, null));
            BusinessRepository.Add(new Business(Guid.NewGuid(), "Bobs Burgers", "bobsburgers1", SetupBusinessAdmin(), null, null, null, null));
            BusinessRepository.Add(new Business(Guid.NewGuid(), "Bob's Burgers #1", "bobsburgers2", SetupBusinessAdmin(), null, null, null, null));
        }
